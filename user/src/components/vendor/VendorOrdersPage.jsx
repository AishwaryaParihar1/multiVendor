  ...
  if (!orders.length) {
    return (
      <div className="p-6 text-center text-gray-600">
        <h2 className="text-2xl font-semibold mb-4">No orders for your products yet!</h2>
        <p>Orders placed for your products by customers will show here.</p>
      </div>
    );
  }

  // Display each order (with only vendor-related products)
  return (
    <div className="p-6 max-w-7xl mx-auto">
      <h2 className="text-3xl font-bold mb-8 text-primary">My Product Orders</h2>
          ...
          <div key={order._id} className="rounded-xl shadow-lg bg-white p-5">
            ...
            >
              <div className="flex-1">
                ...
                <span className="ml-2 text-gray-700">{new Date(order.createdAt || order.placedAt).toLocaleString()}</span>
              </div>
            ...
            {expandedIndex === idx && (
              <div className="mt-4 border-t pt-4">
                <div className="flex flex-col md:flex-row md:gap-10">
                  ...
                  <div className="flex-1">
                    <h4 className="font-semibold mb-2 text-gray-800">Products You Sold In This Order</h4>
                ...
                <div className="mt-6 flex justify-end">
                  <span className="text-xl font-bold text-primary">
                    Total You Received In This Order: ₹
                    {order.items
                      .reduce(
                        (acc, i) => acc + i.quantity * i.priceAtPurchase,
                        0
                      )
                      .toFixed(2)}
                  </span>
